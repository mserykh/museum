...
[+-] вёрстка формы соответствует макету + 7
Требования к css
[+] добавлен favicon +2
...
[-] кнопке "Book" в форме покупки билетов добавлен ripple-эффект  0
[-] при перезагрузке (обновлении) страницы картины в блоке Galery отображаются в рандомном порядке 0
`);
